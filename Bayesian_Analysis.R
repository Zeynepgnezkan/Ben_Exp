...
save(blm_ffd_n, file = "blmm_ffd_n.RData")
summary(blm_ffd_n)
...
save(blm_skip_n, file = "blm_skip_n.RData")
summary(blm_skip_n)
...
save(blm_gd_n, file = "blm_gd_n.RData")
summary(blm_gd_n)
...
save(blm_gp_n, file = "blm_gp_n.RData")
summary(blm_gp_n)
...
save(blm_tvt_n, file = "blm_tvt_n.RData")
summary(blm_tvt_n)
...
save(blmm_ffd_n1, file = "blmm_ffd_n1.RData")
summary(blm_ffd_n1)
...
save(blm_gd_n1m, file = "blm_gd_n1m.RData")
summary(blm_tvt_n1m)
...
save(blm_skip_n1m, file = "blm_skip_n1m.RData")
